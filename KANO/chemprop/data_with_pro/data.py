...
class MoleculeDatapoint:
    ...
    def Class(self, Class: List[float]):
        """
        Sets the targets of a molecule.
...
class MoleculeDataset(Dataset):
    ...
    def pro_id(self) -> List[List[float]]:
        """
        Returns the targets associated with each molecule.

        :return: A list of lists of floats containing the targets.
        """
        return [d.pro_id for d in self.data]


    def index(self) -> List[List[float]]:
        """
        Returns the targets associated with each molecule.
    ...
    def Class(self) -> List[List[float]]:
        """
        Returns the targets associated with each molecule.

        :return: A list of lists of floats containing the targets.
        """
        return [d.Class for d in self.data]
