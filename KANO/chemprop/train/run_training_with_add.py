...
from .evaluate_with_add import evaluate, evaluate_predictions
from .predict_with_add import predict
...
from chemprop.models_add import ContrastiveLoss
    ...
    for model_idx in range(args.ensemble_size):
        ...
        if args.checkpoint_path is not None:
            if args.transfer_learning=='Yes':
                debug(f'transfer learning:Loading model from {args.checkpoint_path}')
                model = build_tr_model(args, encoder_name=args.encoder_name)
                print("model:",model)
