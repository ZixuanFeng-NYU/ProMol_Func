...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--split_type', type=str, default='random',
                        choices=['random', 'scaffold_balanced', 'predetermined', 'crossval', 'index_predetermined','cluster_balanced','stratified_separate_test','stratified'],
    ...
    parser.add_argument("--transfer_learning", default='No',type= str, choices=['Yes','No'],help='transfer learning or not')
